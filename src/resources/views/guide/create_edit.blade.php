    ...
    <div class="row">
        <div class="col-md-8">
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-6">
                        {!! CoralsForm::text('url','utility-guide::attributes.guide.url',true) !!}
                        {!! CoralsForm::select('route','utility-guide::attributes.guide.route', \SEOItems::getRouteManager(), true, null, [], 'select2') !!}
                ...
                <div id="guides-config-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h4>@lang('utility-guide::labels.guide.guide_config')</h4>
                        </div>
                        <div class="col-md-6">
                            <a class="btn btn-success pull-right" id="add-new-guide-config">
                                 @lang('utility-guide::labels.guide.add')
                            </a>
                        </div>
                    </div>

                    @forelse($guide->getProperty('guide_config') ?? [] as $index => $guideConfig)
                        @include('utility-guide::guide.partials.guide_config_fields',compact('index','guideConfig'))
                    @empty
                        @include('utility-guide::guide.partials.guide_config_fields',['index'=>0])
                    @endforelse
                </div>
